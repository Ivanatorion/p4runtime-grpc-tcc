...
class LoadVSwitch():
	...
	def load_switches():
		...
		if (SwitchConf.getSwitchById(switch_id) == False):
			...
			SM_mgmt.create_switch_data("l2", "platform_api/lib/l2/", switch_id, "platform_api/lib/l2/switch_info.dat", "platform_api/lib/l2/table_defines.json", TYPE_PVS)
		...
		if (SwitchConf.getSwitchById(switch_id) == False):
			...
			SM_mgmt.create_switch_data("router", "platform_api/lib/router/", switch_id, "platform_api/lib/router/switch_info.dat", "platform_api/lib/router/table_defines.json", TYPE_PVS)
			...
			Auth.addPermission("ivan2", "router", DEVICE_EVENT | PACKET_EVENT | DEVICE_WRITE | FLOWRULE_WRITE | RESOURCE_WRITE | DEVICE_READ)
		...
		if (SwitchConf.getSwitchById(switch_id) == False):
			...
			SM_mgmt.create_switch_data("int", "platform_api/lib/int/", switch_id, "platform_api/lib/int/switch_info.dat", "platform_api/lib/int/table_defines.json", TYPE_PVS)
			SM_mgmt.load_switch_modules(switch_id)
