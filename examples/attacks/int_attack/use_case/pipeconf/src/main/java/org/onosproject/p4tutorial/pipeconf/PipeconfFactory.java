...
public final class PipeconfFactory {
    ...
    private static final URL P4INFO_URL = PipeconfFactory.class.getResource("/mri.p4.p4info.txt");
    private static final URL BMV2_JSON_URL = PipeconfFactory.class.getResource("/mri.json");
