...
TEMP_NETCFG_FILE = '/home/ivan/Documents/p4tutorial_mininet.json'

ONOS_ROOT = "/home/ivan/onos"
sys.path.append(ONOS_ROOT + "/tools/dev/mininet")
RUN_PACK_PATH = "/home/ivan/onos/tools/package/runtime/bin"
...
class ExerciseRunner:
    ...
    def __init__(self, topo_file, log_dir, pcap_dir,
                       switch_json, bmv2_exe='simple_switch', onos_ip='127.0.0.1', quiet=False):
	...
	Intf('enp0s3', node=self.net.getNodeByName("s4"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s5"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s6"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s7"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s8"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s9"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s10"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s11"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s12"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s13"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s14"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s15"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s16"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s17"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s18"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s19"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s20"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s21"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s22"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s23"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s24"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s25"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s26"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s27"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s28"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s29"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s30"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s31"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s32"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s33"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s34"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s35"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s36"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s37"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s38"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s39"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s40"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s41"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s42"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s43"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s44"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s45"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s46"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s47"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s48"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s49"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s50"), port=255)
	Intf('enp0s3', node=self.net.getNodeByName("s51"), port=255)
...
def get_args():
    ...
    parser.add_argument('--onos_ip', help='ONOS-BMv2 controller IP address',
...
if __name__ == '__main__':
    ...
    exercise = ExerciseRunner(args.topo, args.log_dir, args.pcap_dir,
                              args.switch_json, args.behavioral_exe, args.onos_ip, args.quiet)
